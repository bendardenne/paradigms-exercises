...
\pascal allows programmers to define heterogeneous data structures called \pascalcode{record}s (think of \C's \mintinline{C}{struct}s) containing multiple fields of different types, including other records or enumerations.
