...
\begin{instruction}
	Write facts which describe the following family tree in terms of \prologcode{father/2} and \prologcode{mother/2} and \schemecode{male/1} and \schemecode{female/1}. Names in bold indicate which member of the 
...
Would allow you to query for \schemecode{?- animal(tom)} and obtain true.
