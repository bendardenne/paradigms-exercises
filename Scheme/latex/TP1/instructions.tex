...
Atoms can be combined together with the \schemecode{cons} function to form a \emph{pair}. This constructor function takes two argument and returns a pair, of the which the first item is the first argument and the second item is the second argument. After evaluation, the \scheme interpreter will write a pair \schemecode{(cons 'a  'b)} as:
